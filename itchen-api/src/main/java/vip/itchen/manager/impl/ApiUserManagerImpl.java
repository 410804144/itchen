...
import vip.itchen.manager.IApiUserManager;
...
public class ApiUserManagerImpl implements IApiUserManager {
    ...
    public LoginResp login(LoginReq req) {
        ...
        // 存储到redis
        redisTemplate.opsForValue().set(RedisConst.API_LOGIN_TOKEN_KEY.concat(resp.getUid().toString()), resp, Duration.ofDays(1L));
