...
public class CodeGenerator {
    ...
    public static void main(String[] args) {
        ...
        // 数据库URL
        configObj.put(GeneratorConstVal.DB_URL, "jdbc:mysql://localhost:3306/itchen?autoReconnect=true&useUnicode=true&characterEncoding=UTF-8&failOverReadOnly=false&allowMultiQueries=true&useSSL=false");
        // 数据库用户名
        ...
        configObj.put(GeneratorConstVal.BIZ_MODULE_NAME, "ac");
